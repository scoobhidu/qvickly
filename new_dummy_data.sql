...
-- VALUES ('11ecb180-c115-4407-bcd2-2404c3db8faa'::uuid, 'Home', '123 Main Street', 'Apt 4B', 'New York', 'NY', '10001', 'USA', 9.7128, -9.0060, true, NOW(), NOW());
...
-- VALUES ('vendor_password_123', 'restaurant', 'Marios Pizza', 'Mario Rossi', '9876543211', true, 'https://example.com/vendor.jpg', 'GST123456789', '567890', '09:00:00', '22:00:00', '456 Restaurant Ave, New York, NY', 8.7589, -8.9851, NOW(), NOW(), '791710a2-7e7a-4a63-81fe-2e9216d5ced3'::uuid);
...
-- VALUES (1, 'eb74db64-e32f-49b6-af78-7442a0af7aad'::uuid, NOW(), NOW(), 100, 4.25);
...
-- VALUES ('11ecb180-c115-4407-bcd2-2404c3db8faa'::uuid, NOW(), NOW() + INTERVAL '1 hour', NOW() + INTERVAL '2 hours', NOW() + INTERVAL '3 hours', NOW(), NOW() + INTERVAL '3 hours', NOW(), 'Please handle with care', 25.99, 'delivered');

-- 11. Insert into order_items (depends on orders and grocery_items)
-- INSERT INTO customer.order_items (qty, order_id, item_id)
-- VALUES (4, 'aa8189cc-1cc1-429e-aded-e4b393f714c5'::uuid, 1);
...
-- VALUES ('eb74db64-e32f-49b6-af78-7442a0af7aad'::uuid, 'aa8189cc-1cc1-429e-aded-e4b393f714c5', true);

-- 13. Insert into order_tracker (depends on orders and delivery_boy)
-- INSERT INTO delivery.order_tracker (order_id)
-- VALUES ('aa8189cc-1cc1-429e-aded-e4b393f714c5'::uuid);
...
-- VALUES ('f2f67cae-bd2d-4e33-a52b-03755d94b81f'::uuid, '03a0b248-12d3-4985-a96b-b2629d64457a'::uuid);